...
const FacebookAdMockup = (props: FacebookAdMockupProps) => {
            ...
            <div className="facebook-ad-header">
                <div className="logo-container">
                        <div className="card-media-content">
                            <img id="logo" src={props.company.logo} className="logo-image"/>
                        </div>
                </div>
                <div className="company-container">
                    <div className="company-container-ad">
                            <span
                                data-placeholder="Page Name"
                                data-analytics="Page Name"
                                className="company-editable"
                            >{props.company.name}
                            </span>
    ...
    const getAdBody = () => {
        return (
            <div>
                <figure data-analytics="Main Image" className="single-image card-media editable-image">
                    <div className="card-media-content">
                        <img id="image0" src={props.img?.length > 0 ? props.img[0] : props.product.productImage} className="image"/>
                    </div>
                </figure>
                <div className="preview-below-image flex">
                    <div className="content">
                        <span className="link-displayLink block editable"
                        >{props.company.name}</span>
                        <div className="link-headline-description">
                            <span className="link-headline block editable">{props.headline ? props.headline : 'Headline'}</span>
                            <span className="link-description block editable">{props.description ? props.description : 'Description'}</span>
                        </div>
                    </div>
                    <div className="cta">
                        <div className="fb-button flex custom-select">
                            <span className="dropdown-selection editable download">
                                <span>{props.cta}</span>
                            </span>
                        </div>
                    </div>
    ...
    const getFooterButton = () => {
        return (
            <div className="fb-preview-actions">
                <button className="fb-action fb-like">
                    <i className="fb-action-icon">
                    ...
                    <span className="fb-action-text">Like</span>
                </button>
                <button className="fb-action fb-comment">
                    <i className="fb-action-icon">
                    ...
                    <span className="fb-action-text">Comment</span>
                </button>
                <button className="fb-action fb-share">
                    <i className="fb-action-icon">
                    ...
                    <span className="fb-action-text">Share</span>
                </button>
            </div>
        )
    }
    ...
    return (
        <div id="facebook-container" className="facebook-ad-container">
            <section className={'facebook-ad-section'}>
                {getCompanyHeader()}
                <span className="primaryText">{props.description ? props.description : 'Description'}</span>
                {getAdBody()}
                {getFooterButton()}
            </section>
        </div>
